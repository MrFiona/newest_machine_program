...
class GetAnalysisData(object):
    ...
    def get_hw_data(self, data_type, bkc_flag=True):
        try:
            ...
            effective_header_list = [re.sub('[\r\n\xc2\xa0 ]', '', element) for element in effective_header_list]
...
if __name__ == '__main__':
    ...
    key_url_list = ['https://dcg-oss.intel.com/ossreport/auto/Purley-Crystal-Ridge/Silver/2017%20WW39/6771_Silver.html']
