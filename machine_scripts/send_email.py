...
class SendEmail:
    ...
    def send(self):
        ...
        if self.predict_newest_insert_bkc_string not in ('', 'default_bkc_string'):
            ...
            candidate_string = ''
        SUBJECT = 'BKC ITF Test Plan of %s %s %s %s' % (self.purl_bak_string, lastest_week_string, candidate_string,
        ...
        msg['Subject'] = Header(u'BKC ITF Test Plan of %s %s %s %s' % (self.purl_bak_string, lastest_week_string, candidate_string,
